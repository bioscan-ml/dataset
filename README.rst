...
Every sample has both an image and a DNA barcode, but the taxonomic labels are incomplete and only extend to the species level for around 9% of the speciems.
